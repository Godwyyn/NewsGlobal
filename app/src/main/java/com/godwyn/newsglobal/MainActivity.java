...
import com.godwyn.newsglobal.db.NewsLoader;
import com.godwyn.newsglobal.rss.Parser;
import com.godwyn.newsglobal.service.SyncUtils;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parser.link = "http://www.techrepublic.com/mediafed/articles/latest/";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_technology) {
            ...
            Parser.link = "http://feeds.bbci.co.uk/news/technology/rss.xml?edition=uk";
            fetchCurrentNews();

        } else if (id == R.id.nav_sport) {


            Parser.link = "http://feeds.bbci.co.uk/sport/rss.xml?edition=uk";
            fetchCurrentNews();
        } else if (id == R.id.nav_business) {


            Parser.link = "http://businessnews.com.ng/feed/";
            fetchCurrentNews();

        } else if (id == R.id.nav_local) {

            Parser.link = "http://thenationonlineng.net/feed/";
            fetchCurrentNews();
