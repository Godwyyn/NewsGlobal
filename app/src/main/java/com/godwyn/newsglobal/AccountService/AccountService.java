package com.godwyn.newsglobal.AccountService;
...
public class AccountService extends Service {
     ...
     * @return Handle to application's com.shareqube.nigeriannews.account (not guaranteed to resolve unless CreateSyncAccount()
     *         has been called)
     */
    public static Account GetAccount(String accountType) {
        // Note: Normally the com.shareqube.nigeriannews.account name is set to the user's identity (username or email
        // address). However, since we aren't actually using any user accounts, it makes more sense
        // to use a generic string in this case.
        //
        // This string should *not* be localized. If the user switches locale, we would not be
        // able to locate the old com.shareqube.nigeriannews.account, and may erroneously register multiple accounts.
